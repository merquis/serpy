...
def render_scraping_etiquetas_url():
    ...
    if "json_contenido" in st.session_state:
        ...
        st.session_state["salida_json"] = salida
        ...
        st.session_state["nombre_archivo_exportar"] = nombre_predeterminado

        st.markdown("### 💾 Exportar resultado")
        nombre_archivo = st.text_input("📄 Nombre para exportar el archivo JSON", value=nombre_predeterminado, key="input_nombre_archivo")
