...
def render_scraping_booking():
    ...
    # Acción de subida a Drive
    if st.session_state.get("resultados_json") and st.session_state.get("proyecto_id") and st.session_state.get("subir_drive_booking"):
