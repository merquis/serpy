...
def render_scraping_tripadvisor():
    ...
    st.markdown("Pega una o varias URLs de TripAdvisor (una por línea).")

    urls_raw = st.text_area("🔗 URLs de TripAdvisor", height=200)
    ...
    if st.button("🔎 Scrapear"):
        ...
        for url in urls:
            ...
            # 🧩 Aquí puedes añadir scraping específico de TripAdvisor más adelante
